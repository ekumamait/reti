            ...
            <div className="my-auto sm:mx-auto sm:w-full sm:max-w-md sm:bg-white sm:border sm:rounded-[12px] px-4 py-4" >
                <div className="flex min-h-full flex-col justify-center px-6 py-6 lg:px-8">
                    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <h2 className="mt-6 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Your profile has been successfully created</h2>

                        <p className="mt-2 text-sm text-center text-gray-900">Now you can start exploring RETI!</p>
                    </div>
                    <div className='mt-8'>
                        <Button 
                            type="primary" 
