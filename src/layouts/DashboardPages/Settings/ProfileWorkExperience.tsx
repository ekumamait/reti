...
const Experience = () => {
  ...
  const [experiences, setExperiences] = useState([
    ...
    },
    {
      ...
      endYear: 2023,
      description:
        "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestias magni autem quam, eligendi culpa eum minima sit dicta delectus nihil numquam quaerat, doloremque voluptas molestiae iusto velit. Ea, delectus eum!",
      skills: ["React", "Node.js", "MongoDB"],
    },
  ]);
      ...
      <div className="">
        {experiences.length > 0 ? (
          experiences.map((entry, index) => (
            <div
              key={index}
              className="py-8 grid grid-cols-1 md:grid-cols-2 gap-6 w-full border-b"
            >
