  ...
  useEffect(() => {
    if (profileData) {
      setDetails({
        skillsAndTraining: {
          traineeCategory:
            profileData?.data?.skillsAndTraining?.traineeCategory ||
            "Not specified",
          trainingDuration:
            profileData?.data?.skillsAndTraining?.trainingDuration ||
            "Not specified",
          trainingLocation:
            profileData?.data?.skillsAndTraining?.trainingLocation ||
            "Not specified",
        },
        artisanDetails: {
          categoryOfArtisan:
            profileData?.data?.artisanDetails?.categoryOfArtisan ||
            "Not specified",
          nameOfHost:
            profileData?.data?.artisanDetails?.nameOfHost || "Not specified",
          villageOfArtisan:
            profileData?.data?.artisanDetails?.villageOfArtisan ||
            "Not specified",
          subcountyOfArtisan:
            profileData?.data?.artisanDetails?.subcountyOfArtisan ||
            "Not specified",
          centerRefugeeSettlement:
            profileData?.data?.artisanDetails?.centerRefugeeSettlement ||
            "Not specified",
          hostContact:
            profileData?.data?.artisanDetails?.hostContact || "Not specified",
        },
        geoLocationDetails: {
          partnerResponsible:
            profileData?.data?.geoLocationDetails?.partnerResponsible ||
            "Not specified",
          region:
            profileData?.data?.geoLocationDetails?.region || "Not specified",
          district:
            profileData?.data?.geoLocationDetails?.district || "Not specified",
          settlement:
            profileData?.data?.geoLocationDetails?.settlement ||
            "Not specified",
          subCounty:
            profileData?.data?.geoLocationDetails?.subCounty || "Not specified",
          parishZoneCluster:
            profileData?.data?.geoLocationDetails?.parishZoneCluster ||
            "Not specified",
          village:
            profileData?.data?.geoLocationDetails?.village || "Not specified",
        },
        participantDetails: {
          nameOfParticipant:
            profileData?.data?.participantDetails?.nameOfParticipant ||
            "Not specified",
          groupNumber:
            profileData?.data?.participantDetails?.groupNumber ||
            "Not specified",
          individualNumber:
            profileData?.data?.participantDetails?.individualNumber ||
            "Not specified",
          ...
          maritalStatus:
            profileData?.data?.participantDetails?.maritalStatus ||
            "Not specified",
          specialInterestCategory:
            profileData?.data?.participantDetails?.specialInterestCategory ||
            "Not specified",
          disabilityType:
            profileData?.data?.participantDetails?.disabilityType ||
            "Not specified",
          numberOfDisabilities:
            profileData?.data?.participantDetails?.numberOfDisabilities ||
            "Not specified",
          mainDisabilityDetails:
            profileData?.data?.participantDetails?.mainDisabilityDetails ||
            "Not specified",
          nationalityCategory:
            profileData?.data?.participantDetails?.nationalityCategory ||
            "Not specified",
          uniqueIdNo:
            profileData?.data?.participantDetails?.uniqueIdNo ||
            "Not specified",
        },
      });
    }
